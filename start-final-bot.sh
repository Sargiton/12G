...
pm2 logs whatsapp-final --lines 10

echo ""
echo "🔍 Проверяем логи Telegram бота..."
pm2 logs telegram-final --lines 5

echo ""
echo "✅ ФИНАЛЬНЫЙ БОТ ЗАПУЩЕН!"
echo "📱 WhatsApp: whatsapp-final"
echo "📲 Telegram: telegram-final"
echo ""
echo "🎯 Команды управления:"
echo "• pm2 logs whatsapp-final - логи WhatsApp"
echo "• pm2 logs telegram-final - логи Telegram"
