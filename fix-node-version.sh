...
echo "🔧 УСТАНОВКА NODE.JS 20 И ИСПРАВЛЕНИЕ BAILEYS"
echo "=============================================="
...
echo "📝 Обновляем package.json с совместимой версией Baileys..."
...
echo "📦 Устанавливаем зависимости с совместимой версией Baileys..."
npm install
